...
<body>
    <div class="container">
        ...
        <div class="badge bg-primary text-wrap topright">
            เหนือ: <a id="demo_1">1</a><br><br>
            กลาง: <a id="demo_2">1</a><br><br>
            อีสาน: <a id="demo_3">1</a><br><br>
            ใต้: <a id="demo_4">1</a><br><br>
        </div>
        ...
        <script>
            function getValue_Nuea() {
                ...
                xhttp.open("GET", `./src/getValue/getValue_Nuea.php`, true);
                xhttp.send();
            }

            function getValue_Klang() {
                // const sb = document.querySelector('#majar');
                // const primary_key = sb.selectedIndex;
                var xhttp;
                xhttp = new XMLHttpRequest();
                ...
                xhttp.open("GET", `./src/getValue/getValue_Klang.php`, true);
                xhttp.send();
            }

            function getValue_Esan() {
                // const sb = document.querySelector('#majar');
                // const primary_key = sb.selectedIndex;
                var xhttp;
                xhttp = new XMLHttpRequest();
                ...
                xhttp.open("GET", `./src/getValue/getValue_Esan.php`, true);
                xhttp.send();
            }

            function getValue_Tai() {
                // const sb = document.querySelector('#majar');
                // const primary_key = sb.selectedIndex;
                var xhttp;
                xhttp = new XMLHttpRequest();
                ...
                xhttp.open("GET", `./src/getValue/getValue_Tai.php`, true);
                xhttp.send();
            }

            setInterval(getValue_Nuea, 1000);
            setInterval(getValue_Klang, 1000);
            setInterval(getValue_Esan, 1000);
            setInterval(getValue_Tai, 1000);
        </script>
